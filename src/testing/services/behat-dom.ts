...
export class TestingBehatDomUtilsService {
    ...
    /**
     * Given an element, get it's top-most parent. This could be itself, in case it doesn't have a parent.
     *
     * @param element Element.
     * @returns Parent.
     */
    protected getTopParent(element: HTMLElement): HTMLElement {
        return element.parentElement ? this.getTopParent(element.parentElement) : element;
    }
