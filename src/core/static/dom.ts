...
/**
 * Static class with helper functions for dom.
 */
export class CoreDom {
     ...
     * @param selector Selector to find the element inside the container.
     * @returns Cancellable promise.
     */
     ...
     *
     * @param element Element inside the page to search the header from.
