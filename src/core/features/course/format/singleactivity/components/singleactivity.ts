...
import { CoreCourseFormatBaseComponent } from '@features/course/classes/base-course-format-component';
...
export class CoreCourseFormatSingleActivityComponent extends CoreCourseFormatBaseComponent implements OnChanges {
