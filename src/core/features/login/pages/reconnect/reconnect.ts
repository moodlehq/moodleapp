...
export class CoreLoginReconnectPage implements OnInit, OnDestroy {
    ...
    /**
     * Load the identity provider the user used to authenticate the last time in the app.
     */
    protected async loadSiteIdentityProvider(login: CoreLoginMethodsCurrentLogin): Promise<void> {
        this.currentLogin = login;
    }
