...
export const CORE_GRADES_ACCOUNT_FEATURE_NAME = `${CORE_USER_FEATURE_PREFIX}${CORE_GRADES_COMPONENT_NAME}`;
export const CORE_GRADES_USER_MENU_FEATURE_NAME = `${CORE_GRADES_ACCOUNT_FEATURE_NAME}:viewGrades`;
