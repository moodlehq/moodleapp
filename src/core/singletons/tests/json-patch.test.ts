...
describe('CoreJsonPatch singleton', () => {

    // To test:
    // scenario to test applyPatch with multiple patches
    // scenario to test applyPatches, incuding a failing patch to confirm it doesn't stop the others
    // Scenario to test array patches with [key=value] syntax
    // Scenario to test array patches with primitive values
