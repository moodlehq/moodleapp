...
export class CoreFilepoolProvider {
    ...
    protected static readonly WIFI_DOWNLOAD_THRESHOLD = 20 * CoreBytesConstants.MEGABYTE; // 20MB.
    protected static readonly DOWNLOAD_THRESHOLD = 2 * CoreBytesConstants.MEGABYTE; // 2MB.
