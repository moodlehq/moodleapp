...
export class CoreConstants {
    ...
    /**
     * @deprecated since 5.2. Use CoreDownloadIcon.LOADING instead.
     */
    static readonly ICON_LOADING = 'spinner';
    /**
     * @deprecated since 5.2. Use CoreDownloadIcon.REFRESH instead.
     */
    static readonly ICON_REFRESH = 'fas-rotate-right';
    /**
     * @deprecated since 5.2. Use CoreDownloadIcon.SYNC instead.
     */
