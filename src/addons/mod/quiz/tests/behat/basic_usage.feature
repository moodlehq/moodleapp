...
Feature: Attempt a quiz in app
  ...
  Scenario: Submit a quiz & Review a quiz attempt
    ...
    When I replace "/.*/" within "page-addon-mod-quiz-review ion-card ion-item:nth-child(1) p:nth-child(2)" with "[Started on date]"
    And I replace "/.*/" within "page-addon-mod-quiz-review ion-card ion-item:nth-child(3) p:nth-child(2)" with "[Completed on date]"
