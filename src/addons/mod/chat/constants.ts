...
// Handlers.
export const ADDON_MOD_CHAT_PREFETCH_NAME = ADDON_MOD_CHAT_COMPONENT;
export const ADDON_MOD_CHAT_PREFETCH_MODNAME = ADDON_MOD_CHAT_MODNAME;
export const ADDON_MOD_CHAT_PREFETCH_COMPONENT = ADDON_MOD_CHAT_COMPONENT_LEGACY;
