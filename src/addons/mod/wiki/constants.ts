...
// Handlers.
export const ADDON_MOD_WIKI_PREFETCH_NAME = ADDON_MOD_WIKI_COMPONENT;
export const ADDON_MOD_WIKI_PREFETCH_MODNAME = ADDON_MOD_WIKI_MODNAME;
export const ADDON_MOD_WIKI_PREFETCH_COMPONENT = ADDON_MOD_WIKI_COMPONENT_LEGACY;
