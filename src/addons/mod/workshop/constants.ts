...
// Handlers.
export const ADDON_MOD_WORKSHOP_PREFETCH_NAME = ADDON_MOD_WORKSHOP_COMPONENT;
export const ADDON_MOD_WORKSHOP_PREFETCH_MODNAME = ADDON_MOD_WORKSHOP_MODNAME;
export const ADDON_MOD_WORKSHOP_PREFETCH_COMPONENT = ADDON_MOD_WORKSHOP_COMPONENT_LEGACY;
