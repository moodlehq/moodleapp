...
export class AddonModUrlListLinkHandlerService extends CoreContentLinksModuleListHandler {
...
export const AddonModUrlListLinkHandler = makeSingleton(AddonModUrlListLinkHandlerService);
