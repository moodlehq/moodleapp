 ...
 * @name $mmaModPage
 */
.factory('$mmaModPage', function($mmFilepool, $mmSite, $mmFS, $http, $log, $q, $mmCourse, mmaModPageComponent,
    ...
    function downloadOrPrefetch(module, prefetch) {
        ...
        dwnPromise = $mmCourse.storeModuleStatus(siteid, module.id, mmCoreDownloading, revision, timemod).then(function() {
            ...
            angular.forEach(module.contents, function(content) {
                ...
                if (prefetch) {
                    promises.push($mmFilepool.addToQueueByUrl(siteid, url, mmaModPageComponent, module.id, filetimemodified));
                } else {
                    promises.push($mmFilepool.downloadUrl(siteid, url, false, mmaModPageComponent, module.id, filetimemodified));
                }
            });
