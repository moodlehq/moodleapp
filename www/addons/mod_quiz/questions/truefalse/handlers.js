 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionTruefalseHandler
 */
.factory('$mmaModQuizQuestionTruefalseHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-truefalse';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizTruefalse', 'qtype_truefalse',
                                                        '$mmaModQuizQuestionTruefalseHandler');
    }
});
