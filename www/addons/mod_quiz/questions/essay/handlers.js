 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionEssayHandler
 */
.factory('$mmaModQuizQuestionEssayHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-essay';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizEssay', 'qtype_essay',
                                                        '$mmaModQuizQuestionEssayHandler');
    }
});
