 ...
 * @ngdoc directive
 * @name mmaModQuizQuestionDescription
 */
.directive('mmaModQuizQuestionDescription', function($log, $mmaModQuestionHelper) {
	$log = $log.getInstance('mmaModQuizQuestionDescription');

    return {
        restrict: 'A',
        priority: 100,
        templateUrl: 'addons/mod_quiz/questions/description/template.html',
        link: function(scope) {
