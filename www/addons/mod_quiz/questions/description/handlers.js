 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionDescriptionHandler
 */
.factory('$mmaModQuizQuestionDescriptionHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-description';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizDescription', 'qtype_description',
                                                        '$mmaModQuizQuestionDescriptionHandler');
    }
});
