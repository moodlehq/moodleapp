 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionNumericalHandler
 */
.factory('$mmaModQuizQuestionNumericalHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-numerical';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizNumerical', 'qtype_numerical',
                                                        '$mmaModQuizQuestionNumericalHandler');
    }
});
