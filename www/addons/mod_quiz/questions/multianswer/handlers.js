 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionMultianswerHandler
 */
.factory('$mmaModQuizQuestionMultianswerHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-multianswer';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizMultianswer', 'qtype_multianswer',
                                                        '$mmaModQuizQuestionMultianswerHandler');
    }
});
