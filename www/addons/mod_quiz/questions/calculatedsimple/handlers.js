 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionCalculatedSimpleHandler
 */
.factory('$mmaModQuizQuestionCalculatedSimpleHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-calculated-simple';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizCalculatedSimple', 'qtype_calculatedsimple',
                                                        '$mmaModQuizQuestionCalculatedSimpleHandler');
    }
});
