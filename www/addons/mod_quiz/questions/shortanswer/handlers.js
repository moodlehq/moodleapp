 ...
 * @ngdoc service
 * @name $mmaModQuizQuestionShortAnswerHandler
 */
.factory('$mmaModQuizQuestionShortAnswerHandler', function() {
    ...
    self.getDirectiveName = function(question) {
        return 'mma-mod-quiz-question-short-answer';
    };
...
.run(function($mmAddonManager) {
    ...
    if ($mmaModQuizQuestionsDelegate) {
        $mmaModQuizQuestionsDelegate.registerHandler('mmaModQuizShortAnswer', 'qtype_shortanswer',
                                                        '$mmaModQuizQuestionShortAnswerHandler');
    }
});
