 ...
 */
.directive('mmaModWorkshopAssessmentStrategyNumErrors', function($mmEvents, mmaModWorkshopAssessmentRefreshedEvent,
        ...
        link: function(scope) {
            var obsRefreshed,
                load = function() {
                    ...
                    var originalValues = $mmaModWorkshopAssessmentStrategyNumErrorsHandler.getOriginalValues(
