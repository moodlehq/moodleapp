 ...
 */
.directive('mmaModAssignSubmissionComments', function($state, $mmComments, mmaModAssignSubmissionInvalidated) {
    return {
        restrict: 'A',
        priority: 100,
        ...
        link: function(scope) {
            ...
            $mmComments.isPluginEnabled().then(function(enabled) {
                scope.commentsAvailable = enabled;
                ...
                if (enabled) {
                    ...
                    scope.submissionId = scope.userSubmission.id;
