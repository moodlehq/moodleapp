...
function build_behat_plugin() {
    ...
    # Build Behat plugin for the branch.
    ...
    # Apply new changes to the branch.
...
"
    ...
    echo "Pushing changes to ${branchname} branch..."
    git push
    notify_on_error_exit "Unsuccessful push to ${branchname} branch, stopping..."
