...
- @since tag is meant to know in which version of the backend the function or parameter was added.
- @deprecatedonmoodle tag is meant to know in which version of the backend the function or parameter was deprecated.
